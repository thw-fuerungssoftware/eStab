...
\*****************************************************************************/
  function etb_menue (){
    ...
    echo "<tr>\n";
    echo "<td>";
    echo "<input type=\"image\" name=\"etb_eintrag\" value=\"etb_eintrag\" src=\"".$conf_design_path."/040.jpg\">\n";
    echo "</td>";
    echo "</tr>";
    echo "</table>";
...
\*****************************************************************************/
  function etb_eintragsmenue ($data) {
    ...
    echo "<tr>\n";
    echo "<td>\n";
    echo "<input type=\"image\" name=\"absenden\" alt=\"absenden\" tabindex=\"3\" src=\"".$conf_design_path."/003.jpg\">\n";
    echo "</td><td>\n";
    echo "<input type=\"image\" name=\"abbrechen\" alt=\"abbrechen\" tabindex=\"4\" src=\"".$conf_design_path."/001.jpg\">\n";
    echo "</td>\n";
    echo "</tr>\n";
    echo "</tbody>\n";
    echo "</table>\n";
