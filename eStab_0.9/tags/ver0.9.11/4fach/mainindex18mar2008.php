...
*******************************************************************/
  ...
  /**********************************************************************\
    Überprüfe ob die Listendarstellung eingeschränkgt werden soll
  \**********************************************************************/
...
\**********************************************************************/
  ...
  if ( (isset ($_GET["weiterleiten_x"])) and
     ...
     ( ($formdata ["04_richtung"] == "E") or
       ($formdata ["04_richtung"] == "A") ) ) {

    if ( debug == true ){ echo "### 220 WEITERLEITUNG - Stab_lesen";  echo "<br>\n";}
...
\**********************************************************************/
  if (( $_GET["stab"] == "meldung")){
    ...
    if ( debug == true ){ echo "### 437 Stab Meldung lesen - Darstellung der Meldung ber die laufende Nummer ";  echo "<br>\n";}
