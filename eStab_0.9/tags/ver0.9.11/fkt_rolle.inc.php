...
5 => array ( 
	 ...
	 2 => array ("typ" => "cb", "typ" => "cb", "fkt" => "BD", "rolle" => "FB", "mode" => "ro" ),
	 3 => array ("typ" => "t", "typ" => "t", "fkt" => "", "rolle" => "leer", "mode" => "ro" ),
	 4 => array ("typ" => "t", "typ" => "t", "fkt" => "", "rolle" => "leer", "mode" => "ro" )
)
);
	...
	$conf_empf [9] = array ("fkt" => "OrglRD", "rolle" => "FB" ); 
	$conf_empf [10] = array ("fkt" => "THW", "rolle" => "FB" ); 
	$conf_empf [11] = array ("fkt" => "San", "rolle" => "FB" ); 
	$conf_empf [12] = array ("fkt" => "BD", "rolle" => "FB" ); 
