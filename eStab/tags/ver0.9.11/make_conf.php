...
/*
    $fileline [13] = "include (\"./e_cfg.inc.php\");";
    $fileline [16] = "$"."usertablename11 = $"."conf_4f_tbl [\"usrtblprefix\"].strtolower ($"."_GET [\"funktion\"]).\"_\".strtolower ( $"."_GET [\"kuerzel\"]);  ";
    $fileline [17] = "$"."tblusername11   = $"."conf_4f_tbl [\"usrtblprefix\"].strtolower ($"."_SESSION[\"vStab_funktion\"]).\"_\".strtolower ($"."_SESSION[\"vStab_kuerzel\"]);";
*/
...
//echo ""; var_dump($values); exit;
    ...
    $filename =  $conf_web ["srvroot"].$conf_web ["pre_path"]."/e_cfg.inc.php";
